...
import { Box, Button, Field, Heading, Toggle, Typography } from '@ensdomains/thorin'
...
const Pricing = ({
  ...
  const showPrimaryNameChoice = !isPrimaryLoading && address
